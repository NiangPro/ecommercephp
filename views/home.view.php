        ...
        <div class="col-md-8">
           ...
           <div id="carouselExampleControls" class="carousel slide card-carousel" data-ride="carousel">
              ...
              <div class="card card-product mt-3">
                  <img src="images/accueil.jpg" class="d-block w-100" height="300" style="opacity: 0.5;"  >
                  <div class="d-flex flex-column align-items-center justify-content-center collection mt-5 ml-5" >
                      <div class="p-3 text-center" style="max-width: 700px;">
                          ...
                          <a href="" class="btn btn-warning text-uppercase font-weight-bold text-black py-1 px-1">Voir panier</a>
                      </div>
                  </div>
              </div>
              <!-- fin collection -->
